		...
		<body>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h1 class="text-white">Statistik</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<br>
                <div class="container">
					<div class="row">
							<div class="col-lg-3 col-md-3 ">
								<div class="single-feature mb-30">
									<div class="title d-flex flex-row pb-15">
										<h4 class="text-center">Obyek Wisata</a></h4>
									</div>
									<h3>
									<?php
									$count = DB::table('objek')->count();
									echo $count;
									?>
									</h3>							
								</div>							
							...
							<div class="col-lg-3 col-md-3 ">
								<div class="single-feature mb-30">
									<div class="title d-flex flex-row pb-15">
										<h4 class="text-center">Tiket Terjual</a></h4>
									</div>
									<h3>
									<?php
										$query = DB::table('tikets')->sum('jumlah');
										echo $query;
										?>
									</h3>							
								</div>							
                    ...
                    <br>
                    <div class="w-75 p-3" id="chartPemasukan"></div>
                    <br><br>
                </div>
            </body>
	<br>
