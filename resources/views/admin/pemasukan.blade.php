		...
		<body>
					...
					<div class="row height align-items-center justify-content-center">
						<div class="col-lg-10">
							<div class="generic-banner-content">
								<h1 class="text-white">Rekapitulasi Pemasukan</h1>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">	
				<div class="box-header">
          			<a href="/pemasukan/tambah" class="genric-btn primary circle" role="button" title="Tambah Data"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
          		</div>
				<br/>
					...
					<div class="progress-table">
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>{{ $p->jumlah }}</td>
								<td>
									<a href="/pemasukan/edit/{{ $p->id }}" class="genric-btn link" role="button" title="edit">Edit</a>
									<a href="/pemasukan/hapus/{{ $p->id }}" class="genric-btn link" role="button" title="Tambah Data">Hapus</a>
								</td>
						</tr> 
						@endforeach
						</table>
